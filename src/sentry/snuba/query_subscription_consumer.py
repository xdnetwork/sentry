...
class QuerySubscriptionConsumer:
    ...
    topic_to_dataset: Dict[str, QueryDatasets] = {
        ...
        settings.KAFKA_GENERIC_METRICS_DISTRIBUTIONS_SUBSCRIPTIONS_RESULTS: QueryDatasets.PERFORMANCE_METRICS,
        settings.KAFKA_GENERIC_METRICS_SETS_SUBSCRIPTIONS_RESULTS: QueryDatasets.PERFORMANCE_METRICS,
