...
def get_context(
    ...
    """Compose the various levels of context and add instant messaging fields."""
    return {
        **shared_context,
...
def get_channel_and_integration_by_user(
    ...
    identities = (
        ...
        # In cases where this is not updated to the user_id later, this helps exclude teams.
